...
def can_get_size_of_the_database
  Movie.all.size #|| Movie.count
end

def can_find_the_first_item_from_the_database_using_id
  Movie.all.find_by id: 1 # || Movie.find(1)
end
...
def can_find_using_where_clause_and_be_sorted
  ...
  Movie.where("release_date > '2002'").sort.reverse # || Movie.all.select{|m| m.release_date > 2002}.sort.reverse
end
